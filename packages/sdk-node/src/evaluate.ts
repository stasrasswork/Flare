// Keep in lockstep with apps/api/src/modules/evaluate/evaluate.ts
import { flagBucket } from "./hash.js";
import type { EvalContext, FlagSnapshot, SnapshotFlag, SnapshotFlagType, SnapshotRule } from "./types.js";
